 ...
 * 项目名称：UOKO 系统
 * 类名称：CacoWebResponseExceptionTranslator
 * 创建人：绍华(for dingtalk)
...
import io.uoko.caco.common.security.exception.*;
 ...
 */
public class CacoWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new CacoAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
                HttpStatus.valueOf(status));
