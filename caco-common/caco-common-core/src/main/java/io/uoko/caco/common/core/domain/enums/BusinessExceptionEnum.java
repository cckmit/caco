 ...
 * 项目名称：UOKO 系统
 * 类名称：BusinessExceptionEnum
 * 创建人：绍华(for dingtalk)
 * 联系方式：uokoer@gmail.com
 * 创建时间：2019/5/29
 * 项目官网: https://uoko.io
 */
package io.uoko.caco.common.core.domain.enums;

import io.uoko.caco.common.core.exception.*;
...
public enum BusinessExceptionEnum {
    ...
    public static BusinessExceptionEnum getByExceptionClass(Class<? extends Exception> eClass) {
        if (eClass == null) {
            return null;
        }
